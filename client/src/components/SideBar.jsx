...
const SideBar = ({isMenuOpen, setIsMenuOpen}) => {
  ...
  return (
    <div
      ...
      p-5 dark:bg-gradient-to-b from-[#242124]/30 to-[#000000]/30
    ...
    >
     ...
     <div
        ...
        className="flex items-center gap-2 p-3 mt-4 border 
          border-gray-300 dark:border-white/15 rounded-md cursor-pointer 
      ...
      >
        ...
        <div className="flex flex-col text-sm">
          ...
          <p className="text-xs text-gray-400">Purchase credits to use DhiAI</p>
        </div>
      </div>

      {/* Dark Mode Toggle */}
      <div
        className="flex justify-between items-center gap-2 p-3 mt-4 border 
